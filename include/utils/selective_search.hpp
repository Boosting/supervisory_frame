/**
 * THIS FILE IS PART OF supervisory_frame PROJECT
 * selective_search.hpp - The selective search function for object detection's region proposal
 *
 * THIS PROGRAM IS FREE SOFTWARE, IS LICENSED UNDER MIT LICENSE
 *
 * Copyright (c) 2016 watanika
 * Copyright (c) 2017 dujiajun
 *
 * watanika's original version can be found at:
 * https://github.com/watanika/selective-search-cpp
 */

#ifndef SUPERVISORY_FRAME_SELECTIVE_SEARCH_HPP
#define SUPERVISORY_FRAME_SELECTIVE_SEARCH_HPP
...
#endif //SUPERVISORY_FRAME_SELECTIVE_SEARCH_HPP
